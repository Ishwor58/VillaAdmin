...
<div class="content-wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">File Manager/</span> Create</h4>
                <a href="{{ route('files.index') }}" class="btn btn-primary"> <i class="fa-solid fa-arrow-left"></i> Back to List</a> <hr>
